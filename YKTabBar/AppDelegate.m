...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ViewController *middleVC = [[ViewController alloc] init];
    middleVC.view.backgroundColor = [UIColor blueColor];
    
    ViewController *endVC = [[ViewController alloc] init];
    endVC.view.backgroundColor = [UIColor redColor];
    
    tabbarVC.viewControllers = @[firstVC, middleVC, endVC];
